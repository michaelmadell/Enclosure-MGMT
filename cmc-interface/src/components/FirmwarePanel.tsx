...
export const FirmwarePanel = ({ firmwareData }: { firmwareData: FirmwareEntry[] }) => {
  // Debug logging
...
const FirmwareCard = ({ firmware }: { firmware: FirmwareEntry }) => {
  ...
  return (
    <div className="bg-base-300 p-3 rounded-lg">
      <div className="flex items-start gap-3">
        <Package className="w-4 h-4 mt-0.5 shrink-0 text-primary" />
